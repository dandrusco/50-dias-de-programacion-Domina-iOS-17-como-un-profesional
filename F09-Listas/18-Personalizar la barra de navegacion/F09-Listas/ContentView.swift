...
struct ContentView: View {
    ...
    //2. Para cambiar los colores y/o atributus del titulo lo podemos hacer en el inicializador
    init(){
        //3. definiremos un objeto de la clase UINavigationBarAppearance
        let navbarApparance = UINavigationBarAppearance()
        //4. Le cambiaremos las propiedades al titulo definiendolo en diccionarios
        navbarApparance.largeTitleTextAttributes = [
            .foregroundColor: UIColor.systemTeal,
            .font : UIFont(name: "ArialRoundedMTBold", size: 30)!
        ]
        //6. SI bajamos vemos  que la letra se achica pero sigue de color negro, tambien lo vamos a configurar con titleTextAttributes
        navbarApparance.titleTextAttributes = [
            .foregroundColor: UIColor.systemTeal,
            .font : UIFont(name: "ArialRoundedMTBold", size: 20)!
        ]
        
        //5. Ahora necesitamos decirle que la aplicacion reconozca esta configuracion, por lo tanto configuraremos la apariencia estandar
        UINavigationBar.appearance().standardAppearance = navbarApparance
        
        //7. Ahora necesitamos decirle que la aplicacion reconozca esta configuracion
        UINavigationBar.appearance().scrollEdgeAppearance = navbarApparance
        
        //8. Y por ultimo configuraremos la vista compacta
    ...
    var body: some View {
        NavigationStack{
            ...
            //1. Vamos a cambiar la forma del titulo con navigationBarTitleDisplayMode, el cual cuenta con el automatico, inLine y large
