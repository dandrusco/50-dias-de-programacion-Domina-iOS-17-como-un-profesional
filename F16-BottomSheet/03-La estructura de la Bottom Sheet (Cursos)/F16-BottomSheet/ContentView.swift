...
struct ContentView: View {
    ...
    //3. Cortaremos todos los cursos y los pegaremos dentro de Course
    /*var courses = [
    ...
    var body: some View {
        NavigationStack{
            List{
                //6. en lugar de llamar a courses deberemos llamar a CourseFactory() para recorrer los coursos
