...
struct ContentView: View {
    ...
    var body: some View {
        //2. En versiones anteriores utilizavamos la navigationView, ahora se utiliza la navigationStack
        NavigationStack{
            List{
                //1. Nos quedaremos con la SimpleImageRow, para ellos dejaremos solo courses, sin los indices y el idx sea de course como lo teniamos antes
