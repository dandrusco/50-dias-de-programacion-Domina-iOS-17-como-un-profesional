...
struct ContentView: View {
    ...
    //10. Ahora debede generar una instancia a nuestro ViewMoldel
    ...
    var body: some View {
        VStack {
            ...
            //11. Ahora modificaremos los requisitos agregando variables opcionales. Por ejemplo para el color del icono le preguntaremos al viewModel si la isPassordLengthValid es true que tenga u color X y en el caso de ser falsa que tenga otro color. Tambien agregaremos el iconName y para el tachado, con la misma logica
