...
struct ContentView: View {
    ...
    //2. Como vamos a ir borrando las listas deberemos generar la variable courses con un stado para que sean monitoreadas
    @State var courses = [
    ...
    var body: some View {
        List{
            ...
            //1. En el ForEach meteremos un onDelete quien sera el encargado de llevar a cabo una serie de accicioes
            //2. En el onDelete capturaremos en formato tupla las posiciones que estan afectada por el ondelete, accediendo a las lista de cursos, borrando los cursos en la posicion dado por el indexSet
