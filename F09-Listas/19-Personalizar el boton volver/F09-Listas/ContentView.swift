...
struct ContentView: View {
    ...
    init(){
        ...
        //1. Si hacemos clic en cualquier curso vemos que para volver nos aparece < Cursos de Frogames de color azul, esto tambien es modificable,incluso poner una imagen a eleccion indicandole una mascara de transicion, en nuestro caso pondremos la misma imagen
        ...
        //2. Ahora apreciamos que cambio el icono por defecto por el que le señalamos nosotros.
    }
    ...
    var body: some View {
        ...
        //3. Aqui podemos modificar el color del volver atras incluyendo el icono personalizado
        .tint(.teal)
    }
}
