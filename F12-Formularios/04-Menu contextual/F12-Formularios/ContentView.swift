...
struct ContentView: View {
            ...
            List{
                ForEach(courses) { course in
                    /*NavigationLink(destination: CourseDetailView(course: course)){*/
                        ...
                        //1. Vamos a crear un menu contextual para cuando realicemos una pulsacion prolongada en uno de los cursos, para ello añadiremos el modificador contextMenu
                        .contextMenu{
                            //2. Crearemos una serie de botones
                            Button{
                                //Comprar curso
                                //7. AHora llamaremos a la funcion para comprar pasandole el curso
                                purshase(item: course)
                            } label: {
                                HStack {
                                    Text("Comprar")
                                    Image(systemName: "dollarsign.circle.fill")
                                    //3. Ahora si realizamos una pulsacion prolongada vemos como nos da la opcion de comprar
                                }
                            }
                            //4. Crearemos el segundo boton para favorito
                            Button {
                                //marcar como favorito
                                //8. Lo mimso para favorito
                            ...
                            //5. Crearemos un boton para eliminar el curso de la lista
                            Button {
                                //Eliminar curso
                                //9. Y para eliminar
                                delete(item: course)
    ...
    //6. Deberemos crear 3 funciones para comprar, marcar como favorito y eliminar
