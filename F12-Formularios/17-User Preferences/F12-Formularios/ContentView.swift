...
struct ContentView: View {
    ...
    //7. Creamor una para las SttingsFactory
    var settings : SettingsFactory
    
    //9. Se lo pasamos al inicializador
    init(settings : SettingsFactory){
        ...
        //10. la settings tomara el valor que recibe por parametro
    ...
    var body: some View {
        NavigationStack{
            ...
            .sheet(isPresented: $showSettings) {
                //8. Deberemos pasarle las SettingsFactory
...
#Preview {
    //11. Deberemos pasarle los SettingsFactory a la preview
    ContentView(settings: SettingsFactory())
    //12. Deberemos hacer esto mismo a la F12_FormulariosApp quien es quien lanza la aplicacion
}
