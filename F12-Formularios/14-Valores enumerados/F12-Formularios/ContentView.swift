...
//1 Comenzaremos a crear enumerados para darle funcionalidad a nuestro menu de filtrado, para ello crearemos  un nuevo fichero de tipo Sfiwt File ya que contrandra un tipo de dato y no una vista y la llamaremos SettingFactory
import SwiftUI
