    ...
    var body: some View {
        ZStack{
            VStack{
                ...
                //1. Deberemos programar para que lista se actualice cuando el usuario escriba en la caja de busqueda
                List{
                    //2. para ello debemos modificar el self.tasks, pasandole el filtro, agregando un operador ternario. Si esta vacio no buscamos nada, si no, el titulo que estoy filtrado, contenga lo mismo que estoy buscando
