...
//1. Vamos a implementar UIKit para implementar una barra de busqueda, para ello vamos crear un nuevo fichero de swiftUi llamado SearchBar
import SwiftUI
import SwiftData
...
struct ContentView: View {
    ...
    //13. implementamos un State para el texto a buscar
    //MARK: Texto a buscar
    ...
    var body: some View {
        ZStack{
            VStack{
                ...
                //14. Justo antes de presetnar la lista, pondremos la barra
