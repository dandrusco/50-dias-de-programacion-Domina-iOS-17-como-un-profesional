...
struct ContentView: View {
    ...
    private func shouldShow(course: Course) -> Bool {
        ...
        //1. Para favorito es que si bien el usuario No a marcado como favorito, o bien a marcado mostrar y el curso en cuestion es favorito
        ...
        //2. La del precio es que el precio minimo sea menor o igual al  curso y la su vez el maxPrice sea mayor o igual al curso
