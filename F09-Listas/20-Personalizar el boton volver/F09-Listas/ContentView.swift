...
//1. Si lo que queremos modificar el volver desde SwiftUI deberemos desactivar desde el CourseDetailView

//3. Ahora si entramos en un curso veremos que ya no hay boton atras

//9. AHora ya podemos apretar en cualquier curso y vermos como aparece el icono, el nombre de curso y si apretamos en el boton volvemos a la ventana principal
