...
struct ContentView: View {
    ...
    var body: some View {
        ...
        //1. Cambiaremos el .plain por el .insetGrouped
        .listStyle(.insetGrouped)
        //2. Si le ponemos un color de fondo veremos que este no aparece
        .background(.teal)
        //3. para solucionarlo dedeberos decir que el scroll sea tipo .hidden
