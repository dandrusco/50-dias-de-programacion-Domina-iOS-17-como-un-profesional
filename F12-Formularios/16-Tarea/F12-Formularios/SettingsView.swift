...
struct SettingsView: View {
    ...
    //3. Dejaremos declarado una variable que sea del tipo de a las SettingFactory
...
#Preview {
    //4. Aqui nos da un error es por que aun en la previw no le hemos pasado ninguna SettingsFactory que la hemos creado como requerida (no es opcional)
