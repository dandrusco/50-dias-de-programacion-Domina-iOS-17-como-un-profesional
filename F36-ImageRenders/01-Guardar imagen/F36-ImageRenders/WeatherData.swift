...
//3. En el archivo TemperatureCharts.swift tomaremos los 3 arrays y los pegaremos aqui
let madData = [
...
//4. Creamos un nuevo fichero de SwiftUI llamado ChartView
