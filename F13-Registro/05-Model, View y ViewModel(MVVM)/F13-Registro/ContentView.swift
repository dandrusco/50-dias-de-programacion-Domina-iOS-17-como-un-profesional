...
//1. Crearemos una clase observable para llebar a cabo la validacion tanto de las 3 variables de estado (username, password y passwordValidation). Ademas deberemos guardar los estados para los 4 requisitos que ahora nos muestran el candado rojo. Por lo tanto necesitaremos 7 propiedades
//2. Para ello crearemos un nuevo fichero de Swift y lo llamaremos RegistrationViewModel
