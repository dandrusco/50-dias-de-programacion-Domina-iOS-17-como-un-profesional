...
//1 Hasta ahora si seleccionamos algunas preferencias y luego cerramos la aplicacion estas volveran al estado por defecto ya que aun no las hemos almacenado en ningun registro o BBDD, Swift utiliza una BBDD por defecto llamada UserDefault que se compone de una clave y valor.
//2. Nos iremos a la SettingFactory para agregar esta BBDD
import SwiftUI
